...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], crop=0.0):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")) and not args.json:
            ...
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, args.less, args.max_training_images, '.png', args.max_reso)
        else:
